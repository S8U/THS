...
public class HiddenStringUtil {
	...
	private static final String
			SEQUENCE_HEADER = "§r§n§r",
			SEQUENCE_FOOTER = "§r§o§r";
	...
	public static boolean removeHiddenString(String input) {
		if (input == null) return false;
		...
		String newString = input.substring(0, start) + input.substring(end, input.length());
